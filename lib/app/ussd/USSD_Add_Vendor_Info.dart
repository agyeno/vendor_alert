...
import 'package:vendor_alert/app/ussd/USSD_Add_Name.dart';
...
class USSD_Add_Vendor_Info extends StatefulWidget {
  const USSD_Add_Vendor_Info({Key? key}) : super(key: key);

  @override
  State<USSD_Add_Vendor_Info> createState() => _USSD_Add_Vendor_InfoState();
}

class _USSD_Add_Vendor_InfoState extends State<USSD_Add_Vendor_Info> {
